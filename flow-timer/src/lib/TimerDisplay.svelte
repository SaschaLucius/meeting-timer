<script lang="ts">
    ...
    export function updateDisplay({ name: newName, time: newTime, repetitions: newRepetions, description: newDescription }: { name: string, time: number, repetitions: number, description: string }) {
