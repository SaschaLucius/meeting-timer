...
export function getTimerDefinitions(): Record<string, Timer> {
	return {
		Countdown: { name: 'Countdown', duration: 300 },
		'Wicked Questions': {
		...
		'1-2-4-All': {
			...
			timers: [
				...
				},
				{
					...
					duration: 300,
					description: 'Each group shares one standout idea with the whole group. Repeat as needed.'
				}
			]
		},
		'15% Solution': {
		...
		'Impromptu Networking': {
			...
			timers: [
				...
				},
				{
					name: 'Round 2',
					duration: 300,
					description: 'Participants switch partners and repeat the process with a new connection.'
				},
				{
					name: 'Round 3',
					duration: 300,
